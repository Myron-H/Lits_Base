...
public class Main {
    public static void main(String[] args) {
        ...
        Truck man = new Truck("MAN", "Welly", 2017, 28.500f, 120,
                125638, "diesel", 14.6);
        Truck renault = new Truck("RENAULT", "Marius", 2018, 29.000f, 130,
                258600, "diesel", 12.6);
        Truck scania = new Truck("SCANIA", "Century", 2019, 26.000f, 110,
                565289, "gaz", 14.8);

        // Гараж для вантажних авто з використанням Generics
        Garage<Truck> garageTruck = new Garage<>(man, renault, scania);
        System.out.println("Garage Trucks:");
        ...
        System.out.println("Garage AutoMix:");
